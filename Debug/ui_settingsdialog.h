...
public:
    ...
    QLabel *label;
    QSpinBox *LidarSpinBox;
    QCheckBox *showBadPointsCheckBox;

    void setupUi(QDialog *SettingsDialog)
    {
        if (SettingsDialog->objectName().isEmpty())
            SettingsDialog->setObjectName(QStringLiteral("SettingsDialog"));
        SettingsDialog->resize(397, 390);
        ...
        LidarSpinBox = new QSpinBox(additionalOptionsGroupBox);
        LidarSpinBox->setObjectName(QStringLiteral("LidarSpinBox"));
        LidarSpinBox->setMaximumSize(QSize(100, 16777215));
        LidarSpinBox->setMinimum(1);
        LidarSpinBox->setMaximum(10);
        LidarSpinBox->setValue(3);

        verticalLayout->addWidget(LidarSpinBox);

        showBadPointsCheckBox = new QCheckBox(additionalOptionsGroupBox);
        showBadPointsCheckBox->setObjectName(QStringLiteral("showBadPointsCheckBox"));
        showBadPointsCheckBox->setChecked(false);

        verticalLayout->addWidget(showBadPointsCheckBox);
    ...
    void retranslateUi(QDialog *SettingsDialog)
    {
        ...
        additionalOptionsGroupBox->setTitle(QApplication::translate("SettingsDialog", "LIDAR Options", 0));
        label->setText(QApplication::translate("SettingsDialog", "LIDAR Range (1 - 10) m:", 0));
        showBadPointsCheckBox->setText(QApplication::translate("SettingsDialog", "Show bad points", 0));
    } // retranslateUi
